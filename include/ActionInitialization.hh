...
#ifndef B4ActionInitialization_h
#define B4ActionInitialization_h 1
...
/// initialize the actions like runAction, eventAction, steppingAction, GeneratorPrimaryAction by SetUserAction()
